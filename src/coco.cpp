...
void train_coco(char *cfgfile, char *weightfile)
{
    ...
    char *train_images = "/home/mw4vision/Desktop/sachin/yolo_cpp-master/data/ImageList_train.txt";
    //char *train_images = "data/bags.train.list";
    char *backup_directory = "/home/mw4vision/Desktop/Backup/";
    srand(time(0));
    ...
    clock_t time;
    printf("branches %d %d\n",net.max_batches, get_current_batch(net)  );
    //while(i*imgs < N*120){
